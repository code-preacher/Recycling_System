...
$crud->insertLocationCharge($_POST);
}
...
?>
      ...
      <div class="content-wrapper">
       ...
       <section class="content-header">
          <h1>Add Location Charge
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Add Location Charge</li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                      ...
                      echo "<option><center>No Location at the moment</center</option>";
                    }
                    ?>
                          </select>
							            </div>
                                  ...
                                  <div class="col-md-12">
                                  <div class="form-group has-feedback">
                          <!-- <input type="text" class="form-control" placeholder="Waste Type" name="type" required="required" /> -->
                          <select class="form-control" required="required" name="type">
                                      ...
                                      <option value="DRUM (BIG)">DRUM (BIG)</option>
                                       <option value="DRUM (MEDIUM)">DRUM (MEDIUM)</option>
                                        <option value="DRUM (SMALL)">DRUM (SMALL)</option>
                            </select>
                          </div>
                                  </div>
                          ...
                          <input type="text" class="form-control" placeholder="Charge" name="charge" required="required" />
                            			 ...
                            			 <div class="col-md-4">
							             <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-plus"></i>&nbsp;Add Location Charge</button>
							             </div>
